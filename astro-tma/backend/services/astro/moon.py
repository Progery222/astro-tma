...
try:
    from kerykeion import MoonPhaseDetailsFactory as _MoonFactory
except ImportError:
    from kerykeion.moon_phase_factory import MoonPhaseFactory as _MoonFactory  # type: ignore[no-redef]
...
def get_moon_phase(dt: datetime | None = None) -> MoonPhaseInfo:
    ...
    factory = _MoonFactory(subject)
    # v5: MoonPhaseDetailsFactory exposes attributes directly on the factory object
    # v4: .get_phase() returned a dataclass; try both
